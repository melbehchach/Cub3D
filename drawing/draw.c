...
{
	obj->newx =  obj->ply.posx + cos(obj->ply.rotationangle) * obj->ply.movestep;
	obj->newy =  obj->ply.posy + sin(obj->ply.rotationangle) * obj->ply.movestep;
}
...
static void	move_left_right(t_data *obj)
{
	if (obj->key == 0)
	{	
		obj->newx =  obj->ply.posx + cos(obj->ply.rotationangle + (M_PI_2)) * obj->ply.movestep;
		obj->newy =  obj->ply.posy + sin(obj->ply.rotationangle + (M_PI_2)) * obj->ply.movestep;
	}
	else if (obj->key == 2)
	{
		obj->newx =  obj->ply.posx - cos(obj->ply.rotationangle - (M_PI_2)) * obj->ply.movestep;
